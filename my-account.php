...
<body>
    ...
    <div class="main-wrapper">
        ...
        <main class="main-content main-account">
            <div class="row mx-auto container">
                ...
                <div class="col-sm-12 mt-5 mb-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text"> При покупке этой подписки, Вам будет доступен видеоматериа в течение одного месяца.
                            </p>
                ...
                <div class="col-sm-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Приобрести побписку на 3 месяца</h5>
                            <p class="card-text">
                                При покупке этой подписки, Вам будет доступен видеоматериа в течение 3 месяцев.
                            </p>
                            <a href="#" class="btn btn-success">Купить</a>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 mt-5 mb-5">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Приобрести побписку на год</h5>
                            <p class="card-text"> При покупке этой подписки, Вам будет доступен видеоматериа в течение одного года.
                            </p>
                            <a href="#" class="btn btn-success">Купить</a>
                        </div>
                    </div>
        ...
        <!-- Begin Footer Area -->
        <footer class="footer-area footer-sticky" data-bg-image="assets/images/footer/bg/1-1920x465.jpg">
