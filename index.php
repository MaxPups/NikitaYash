                                ...
                                <div class="row">
                                    <div class="col-lg-6 order-2 order-lg-1 align-self-center">
                                        <div class="slide-content text-black">
                                            ...
                                            <h2 class="title">New Plant2</h2>
                                            <p class="short-desc">Pronia, With 100% Natural, Organic & Plant Shop.22</p>
                                        ...
                                        <div class="inner-img">
                                            <div class="scene fill">
                                                <div class="expand-width" data-depth="0.2">
                                                    <img src="assets/images/contact/1-1-370x500.jpg" alt="Inner Image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="section-title-wrap without-tab">
                        ...
                        <p class="section-desc">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aliquam,
                            perspiciatis praesentium? Dolorum repudiandae voluptates aliquam voluptatum obcaecati beatae
                            suscipit! Corporis hic aliquid laudantium architecto! Facere, animi dolores inventore
                            officia aperiam ea consequatur numquam voluptatibus maxime distinctio nostrum itaque veniam
                            enim repellat consequuntur quisquam libero neque voluptates vel fugit repellendus
                            aspernatur! Harum illum mollitia, quibusdam modi consectetur, explicabo dolor corporis nulla
                            atque magni ratione saepe illo deleniti excepturi cupiditate voluptate asperiores nesciunt
                            perferendis sequi adipisci animi alias, placeat voluptatem. Quod corrupti laboriosam, soluta
                            nemo, corporis impedit vero placeat recusandae dolore id facilis unde nulla voluptatibus
                            labore est voluptates. Dolor officia eius perferendis quae velit. Quaerat nostrum
                            voluptatibus eveniet neque assumenda, fugiat ipsam rem mollitia incidunt earum sunt ipsa
                            dicta perspiciatis tempore fuga quidem voluptates eos numquam quis. Illum voluptate odio
                            fugiat voluptas, nihil autem laboriosam ea nemo doloribus praesentium saepe veniam nulla
                            aliquid? Voluptates id fuga, veniam error vitae, vero maxime magni similique asperiores
                            blanditiis rem aperiam deleniti, illum nihil cumque minus explicabo! Quaerat tempore
                            quisquam recusandae necessitatibus repellendus, nemo omnis ex tempora consectetur
                            perferendis porro commodi in quibusdam ratione ullam voluptate, suscipit laborum? Tempora,
                            fugiat eum doloremque iste ipsa voluptates, voluptate ab doloribus debitis ea minus voluptas
                            vel eaque. Similique.
                        </p>
                    </div>
                                ...
                                <div class="single-product-content">
                                    ...
                                    <ul class="quantity-with-btn">
                                        ...
                                        <li class="add-to-cart">
                                            <a class="btn btn-custom-size lg-size btn-pronia-primary" href="cart.php">Add to
                                                cart</a>
                                        </li>
                                        <li class="wishlist-btn-wrap">
                                            <a class="custom-circle-btn" href="wishlist.php">
                                                <i class="pe-7s-like"></i>
                                            </a>
                                        </li>
                                        <li class="compare-btn-wrap">
                                            <a class="custom-circle-btn" href="compare.php">
